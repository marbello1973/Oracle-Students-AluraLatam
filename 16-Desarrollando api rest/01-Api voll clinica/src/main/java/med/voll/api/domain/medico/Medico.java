...
public class Medico {
    ...
    public void actualizarDatos(ActualizarMedicoDTO actualizarMedicoDTO) {
        ...
        if(actualizarMedicoDTO.documento() != null)  this.documento = actualizarMedicoDTO.documento();
        if(actualizarMedicoDTO.direccion() != null){
            this.direccion = direccion.actualizarDatos(actualizarMedicoDTO.direccion());
        }
    }
